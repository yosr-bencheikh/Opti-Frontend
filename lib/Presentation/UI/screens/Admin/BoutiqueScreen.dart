 ...
 Widget _buildAdvancedFilters() {
  return BoutiqueFilterWidget(
    ...
    onFilterChanged: (newFilters) {
      setState(() {
        _filters['nom'] = newFilters['nom']!.isNotEmpty ? newFilters['nom'] : null;
        _filters['adresse'] = newFilters['adresse']!.isNotEmpty ? newFilters['adresse'] : null;
        _filters['ville'] = newFilters['ville']!.isNotEmpty ? newFilters['ville'] : null;
        _filters['email'] = newFilters['email']!.isNotEmpty ? newFilters['email'] : null;
        _filters['phone'] = newFilters['phone']!.isNotEmpty ? newFilters['phone'] : null;
        _filters['description'] = newFilters['description']!.isNotEmpty ? newFilters['description'] : null;
        _filters['horaires'] = newFilters['horaires']!.isNotEmpty ? newFilters['horaires'] : null;
      });
      _filterOpticiens();
    },
  );
            ...
            Expanded(
              child: AnimatedSwitcher(
                ...
                child: boutiques.isEmpty 
                    ...
                    : ListView.separated(
                        key: ValueKey(boutiques.length), // Important pour l'animation
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            key: ValueKey(boutique.id), // Important pour les animations
