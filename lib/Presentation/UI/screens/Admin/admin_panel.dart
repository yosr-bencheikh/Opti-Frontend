...
class AdminPanelApp extends StatelessWidget {
  ...
  Widget _buildProductsChart() {
    ...
    // Observable pour l'animation
    final animationProgress = 0.0.obs;

    // Observable pour choisir le type de graphique
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Ligne contenant les deux sélecteurs
                Row(
                  children: [
                    ...
                    // Dropdown pour sélectionner le nombre de produits
                    Expanded(
                ...
                Expanded(
                  child: AnimatedSwitcher(
                    ...
                    child: chartType.value == "bar"
                        ? _buildBarChart(topProducts, productController,
                            animationProgress.value)
                        : _buildPieChart(topProducts, productController,
                            animationProgress.value),
                  ),
                ),
...
// Version optimisée des dropdowns pour l'affichage en ligne
  ...
  Widget _buildBarChart(List<MapEntry<String, int>> topProducts,
      ProductController productController, double animationProgress) {
    return topProducts.isEmpty
        ? Center(child: Text("Aucune donnée disponible pour ce mois"))
        : BarChart(
            BarChartData(
              ...
              barTouchData: BarTouchData(
                ...
                touchTooltipData: BarTouchTooltipData(
                  getTooltipColor: (group) =>
                      Color(0xFF2D4263).withOpacity(0.8),
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                color:
                                    Color.fromARGB(255, 48, 183, 104), // Vert pastel de statut
                                shape: BoxShape.circle,
                                boxShadow: [
                                  BoxShadow(
