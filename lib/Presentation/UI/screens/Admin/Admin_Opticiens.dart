...
Widget build(BuildContext context) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Intégrer le filtre et le tableau dans une structure Expanded
                    Expanded(
                      child: Column(
                        children: [
                          // Si les filtres sont visibles, montrer le widget mais avec une hauteur fixe
                          if (_showFilters)
                            OpticianFilterWidget(
                              ...
                              onFilterChanged: (newFilters) {
                                setState(() {
                                  ...
                                  _selectedPrenom = newFilters['prenom'] ?? '';
                                  _selectedDate = newFilters['date'] ?? '';
                                  _selectedRegion = newFilters['region'] ?? 'Toutes les régions';
                                  _selectedGenre = newFilters['genre'] ?? 'Tous les genres';
                                });
                                _filterOpticians();
                              },
                            ),
                          ...
                          // Le tableau occupe l'espace restant
                          Expanded(
  ...
  Widget _buildPagination() {
    if (_filteredOpticians.isEmpty ||
        _filteredOpticians.length <= _usersPerPage) {
      return const SizedBox.shrink();
    }

    final int totalPages = (_filteredOpticians.length / _usersPerPage).ceil();
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            'Affichage de ${_startIndex + 1} à $_endIndex sur ${_filteredOpticians.length} utilisateurs',
            style: TextStyle(
                ...
                onChanged: (value) {
                  if (value != null) {
                    setState(() {
                      _usersPerPage = value;
                      int maxPage =
                          (_filteredOpticians.length / _usersPerPage).ceil();
  ...
  List<Optician> _getDisplayedOpticians() {
    return _filteredOpticians.length <= _opticiansPerPage
        ? _filteredOpticians
...
// Construction d'une ligne de données pour un opticien
  DataRow _buildDataRow(Optician optician) {
            ...
            children: [
              ...
              AnimatedContainer(
                ...
                child: ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _showFilters ? _primaryColor : Colors.white,
