        ...
        child: Row(
          ...
          children: [
            Icon(
              ...
              size: 16,
              color: _isAnimating ? Colors.green : _pastelColors[2],
            ),
            const SizedBox(width: 6),
            Text(
        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              final itemsPerRow = constraints.maxWidth > 600 ? 6 : 4;
              ...
              return Column(
                children: List.generate(rowCount, (rowIndex) {
                  ...
                  final rowItems = data.entries.toList().sublist(
                        startIndex,
